...
Как и главная страница, она состоит из двух частей. Слева - список последних заказов, справо - счетчик заказов.

На данной странице реализовано соединение с помощью websockets, в режиме реально времени происходит обновление списка заказов,номеров выполенных заказов и заказов, находящихся в работе.
