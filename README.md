...
В проекте выполнен роутинг. При открытии модального окна в браузерной строке появляется уникальная ссылка. Если скопировать ссылку из браузерной строки и вставить ее на новой странице, то на странице отобразиться информация из модального окна. При обновлении страницы, модальное окно останется открытым. 
